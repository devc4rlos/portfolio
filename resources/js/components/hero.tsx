...
export default function Hero({
    ...
    return (
        <section className="relative flex min-h-[calc(80vh-64px)] items-center justify-center overflow-hidden bg-linear-to-r from-[#5e3eef1c] to-[#d4dfdf0a] to-50% bg-cover bg-no-repeat px-6 py-20">
